					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
								<img style="width: 50px;height: 50px;" src="{{asset('image/logo-xs.png')}}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">
									{{ auth()->user()->name }}
								</span>
							</a>
			...
			<main class="content">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item  {{ $loop->last ? 'active' : '' }}"><a href="{{route($segmento)}}">

								{{ ucfirst($segmento) }}
							</a></li>

						@else
						<li class="breadcrumb-item  {{ $loop->last ? 'active' : '' }}"><a href="#"> {{ ucfirst($segmento) }} </a></li>

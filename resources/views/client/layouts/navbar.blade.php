                   ...
                   <div class="collapse navbar-collapse" id="navbarsExample04">
                      ...
                      <ul class="navbar-nav mr-auto">
                         ...
                         <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ url('categorias')}}">Categorías de animales </a>
                         ...
                         @auth
                         <li class="nav-item">
                            <a onclick="event.preventDefault();if( confirm('¿CERRAR SESIÓN?')) $('#logoutform').submit();" class="nav-link text-warning" href="{{route('logout')}}">
                               Cerrar sesión
                            </a>

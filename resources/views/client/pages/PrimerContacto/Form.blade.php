...
<div class="card m-0" id="contactForm" style="background: #000000d4;padding-inline: 30px;min-height: 100vh;">
    ...
    <div class="gallery position-relative">
        <img src="{{asset('image/collage/img1.webp')}}" alt="">
        <img src="{{asset('image/collage/img2.jpg')}}" alt="">
        <img src="{{asset('image/collage/img3.jpg')}}" alt="">
      {{--  @foreach ( $categories as $cate)

        <img src="{{$cate->image_url}}" alt="">
        @endforeach --}}
    </div>
...
<i class="fa fa-whatsapp"></i>
            ...
            <div class="col-12">
                <div id="LOGO_BOTTOM" class="position-relative mx-auto">
                    <img class="mx-auto" src="{{asset('image/logo_original_landing.png')}}" alt="">

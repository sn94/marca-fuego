...
-->
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="<?php echo e(route('perfil')); ?>"><i class="align-middle me-1" data-feather="user"></i> Perfil</a>
               
                    <div class="dropdown-divider"></div>
                    <a onclick="if( confirm('¿CERRAR SESIÓN?')) $('#logoutform').submit();"  class="dropdown-item" href="#">
...
</nav><?php /**PATH C:\xampp\htdocs\marca-fuego\resources\views/admin/layouts/navbar.blade.php ENDPATH**/ ?>
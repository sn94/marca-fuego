<footer id="contact">
      <div class="footer">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-12">
                  <?php echo $__env->make('client.contact_us', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
               </div>
               ...
               <div class="col-md-3 border_right">
                  ...
                  <ul class="link">
                     ...
                     <li><a href="<?php echo e(route('client.us')); ?>">Nosotros</a></li>
                     <li><a href="<?php echo e(route('client.categorias')); ?>">Productos</a></li>
                     <li><a href="<?php echo e(route('client.news')); ?>">Novedades</a></li>
                     <li><a href="<?php echo e(route('home') .'#CONTACT-FORM'); ?>">Contacto</a></li>
                  </ul>
               </div>
               <div class="col-md-3">
                  <form class="bottom_form"  action="<?php echo e(route('client.subscription')); ?>" method="POST">
                     <?php echo csrf_field(); ?>
                     <h3>Informativo</h3>
   ...
   </footer><?php /**PATH C:\xampp\htdocs\marca-fuego\resources\views/client/layouts/footer.blade.php ENDPATH**/ ?>
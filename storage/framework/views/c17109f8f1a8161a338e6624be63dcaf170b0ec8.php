            ...
            <div class="col-12 col-md-5 pl-0 pr-5  " style="min-height: 100vh;">
                ...
                <div class="container" style="background: #806f0bcc;">
                    ...
                    <div class="form-check">
                        <input onchange="updateForm(  )" class="form-check-input" type="radio" name="tipoformulario" value="registrado" id="registrado">
                        <label class="form-check-label text-light" for="registrado">
                            Ya estoy registrado
                        </label>
                    </div>
                    <div class="form-check">
                        <input onchange="updateForm(  )" class="form-check-input" type="radio" name="tipoformulario" value="no_registrado" id="no_registrado" checked>
...
</html><?php /**PATH C:\xampp\htdocs\marca-fuego\resources\views/client/pages/PrimerContacto/Welcome.blade.php ENDPATH**/ ?>